...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public struct Stats
        {
            ...
            [Tooltip("超级加速道具的加成系数")] public float SuperSpeedBoost;
        ...
        public ArcadeKart.Stats baseStats = new ArcadeKart.Stats
        {
            ...
            Grip = .95f,
            AddedGravity = 1f,
            SuperSpeedBoost = 1.5f, // This is a custom stat for super speed boost powerup
        };
        ...
        readonly List<(WheelCollider wheel, float horizontalOffset, float rotation, ParticleSystem sparks)>
            m_DriftSparkInstances = new List<(WheelCollider, float, float, ParticleSystem)>();
        ...
        void GatherInputs()
        {
            ...
            input.IsBoosting = UnityEngine.Input.GetKey(KeyCode.LeftShift) ||
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            if (Input.IsBoosting)
            {
                maxSpeed *= m_FinalStats.SuperSpeedBoost;
                accelPower *= m_FinalStats.SuperSpeedBoost;
            }
